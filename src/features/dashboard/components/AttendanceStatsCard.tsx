...
export const AttendanceStatsCard = ({ stats, period: _period }: AttendanceStatsCardProps) => {
  ...
  return (
    <BaseStatsCard title="Asistencias" icon={Activity} iconColor="red">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3 pb-3 border-b border-gray-100">
